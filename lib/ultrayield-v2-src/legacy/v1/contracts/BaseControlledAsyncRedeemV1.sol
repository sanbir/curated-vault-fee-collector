...
import { TimelockedUUPSUpgradeableV1 } from "uyv2/legacy/v1/contracts/TimelockedUUPSUpgradeableV1.sol";
import { SafeERC20, IERC20 } from "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";
import { Math } from "@openzeppelin/contracts/utils/math/Math.sol";
import { PendingRedeem, ClaimableRedeem } from "uyv2/interfaces/Types.sol";
import { IRedeemAccountingV1 } from "uyv2/legacy/v1/interfaces/IRedeemAccountingV1.sol";
import { IUltraVaultRateProviderV1 } from "uyv2/legacy/v1/interfaces/IUltraVaultRateProviderV1.sol";
...
import { RedeemQueueV1 } from "uyv2/legacy/v1/contracts/RedeemQueueV1.sol";
import { IBaseVaultV1Errors, IBaseVaultV1Events } from "uyv2/legacy/v1/interfaces/IBaseVaultV1.sol";
...
/// @dev Initialization parameters for BaseControlledAsyncRedeemV1
...
/// @title BaseControlledAsyncRedeemV1
/// @notice Base contract for controlled async redeem flows
/// @dev Based on ERC-7540 Reference Implementation
abstract contract BaseControlledAsyncRedeemV1 is
    AccessControlUpgradeable,
    ERC4626Upgradeable,
    PausableUpgradeable,
    TimelockedUUPSUpgradeableV1,
    RedeemQueueV1,
    IERC7540Operator,
    IRedeemAccountingV1,
    IBaseVaultV1Errors,
    IBaseVaultV1Events
{
    ...
    struct BaseAsyncRedeemStorage {
        ...
        IUltraVaultRateProviderV1 rateProvider;
    ...
    function initialize(
        ...
        // Init self
        _getBaseAsyncRedeemStorage().rateProvider = IUltraVaultRateProviderV1(params.rateProvider);
    ...
    function rateProvider() public view returns (IUltraVaultRateProviderV1) {
    ...
    /// @inheritdoc IRedeemAccountingV1
    ...
    function acceptProposedRateProvider(address newRateProvider) external onlyOwner {
        ...
        $.rateProvider = IUltraVaultRateProviderV1(newRateProvider);
