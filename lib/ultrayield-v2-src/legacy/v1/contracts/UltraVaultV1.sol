...
import { Fees, IUltraVaultV1Events, IUltraVaultV1Errors } from "uyv2/legacy/v1/interfaces/IUltraVaultV1.sol";
...
import { BaseControlledAsyncRedeemV1, BaseControlledAsyncRedeemInitParams } from "uyv2/legacy/v1/contracts/BaseControlledAsyncRedeemV1.sol";
import { OPERATOR_ROLE } from "uyv2/utils/Roles.sol";
...
contract UltraVaultV1 is BaseControlledAsyncRedeemV1, IUltraVaultV1Events, IUltraVaultV1Errors {
    ...
    function initialize(
        ...
        $.oracle = IPriceSourceV1(params.oracle);
        _pause();
    ...
    function oracle() public view returns (IPriceSourceV1) {
    ...
    function acceptProposedOracle(address newOracle) external onlyOwner {
        ...
        UltraVaultStorage storage $ = _getUltraVaultStorage();
        $.oracle = IPriceSourceV1(newOracle);
