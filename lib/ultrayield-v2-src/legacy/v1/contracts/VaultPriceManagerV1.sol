...
import { IUltraVaultOracleV1 } from "uyv2/legacy/v1/interfaces/IUltraVaultOracleV1.sol";
import { IOwnable } from "uyv2/interfaces/IOwnable.sol";
import { IERC20Supply } from "uyv2/interfaces/IERC20Supply.sol";
...
contract VaultPriceManagerV1 is Ownable2Step {
    ...
    IUltraVaultOracleV1 public oracle;
    ...
    constructor(address _oracle, address _owner) Ownable(_owner) {
        ...
        oracle = IUltraVaultOracleV1(_oracle);
    }
    ...
    function setOracle(
        ...
        if (address(oracle) != _newOracle) {
            ...
            oracle = IUltraVaultOracleV1(_newOracle);
        }
    }
