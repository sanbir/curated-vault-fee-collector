...
import { IPriceSourceV1 } from "./IPriceSourceV1.sol";
...
/// @title IUltraVaultOracleV1
/// @notice Interface for push-based price oracle
/// @dev Extends IPriceSourceV1 with price setting capabilities
interface IUltraVaultOracleV1 is IPriceSourceV1 {
    ////////////
    // Events //
    ////////////
